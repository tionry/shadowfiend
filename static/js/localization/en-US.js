...
app.languages['en-US'] = { Name :'English Version',
  ...
  'problem name error'      : 'problem name length must be less than 20 and contain no illegal chars',
  ...
  'not an onRound interviewee' : 'Sorry, you have not been called into the interview round.',
  ...
  'Next'                    : 'Next',
  'youcanleavenow'          : 'Coding Completed. Feel free to leave now.',
  'leave'                   : 'leave',
