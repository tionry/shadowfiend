...
app.languages['zh-CN'] = { Name : '中文版',
  ...
  'problem exists'			: '该题目已经存在',
  'problem not found'		: '找不到题目',
  ...
  'problem name error'		: '题目名称长度不能大于20且不能包含非法字符',
  ...
  'not an onRound interviewee'     : '您不在当前轮次中，请耐心等待...',
